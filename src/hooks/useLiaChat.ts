...
export const useLiaChat = (companionName: string = "Lia", goalsSummary?: GoalsSummary, personalitySummary?: string, phdModeEnabled: boolean = false, roleplayPrompt: string = "") => {
  const { 
    memory, 
    addMessage, 
    setUserName, 
