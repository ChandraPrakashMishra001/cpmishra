...
export default defineTool({
  ...
  title: "Ask Amanai",
  description:
    "Ask Amanai, an expert general-purpose AI assistant, any question in any domain (science, code, medicine, business, agriculture, general knowledge) and get an accurate expert answer.",
  inputSchema: {
